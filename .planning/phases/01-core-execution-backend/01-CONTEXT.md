...
- **D-03:** Define an interface and use the Go Docker SDK to ensure programmatic container management for strict execution isolation.
...
No specific requirements — open to standard approaches using Go Docker SDK.
